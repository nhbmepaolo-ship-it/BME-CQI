...
export const createEmptyCPIForm = (): CPIFormData => {
  ...
  return {
    ...
    deptHeadSignature: '',
    deptHeadName: '',
    deptHeadPosition: 'ผู้จัดการแผนกผู้ป่วยนอก',
    deptHeadDate: '',
...
export const PRESET_CPI_TEMPLATES: { name: string; dept: string; data: Partial<CPIFormData> }[] = [
  {
    ...
    data: {
      ...
      deptHeadName: 'ภก. สมชาย ชัยประเสริฐ',
      deptHeadPosition: 'หัวหน้าฝ่ายเภสัชกรรม',
      deptHeadDate: '03/05/2567',
      projectOwnerNamePage2: 'ภญ. ศิริพร วิเศษสุข',
      projectOwnerDatePage2: '01/08/2567',
      approverName: 'นพ. ประสิทธิ์ สุวรรณเดช',
  ...
  },
  {
    ...
    data: {
      ...
      deptHeadName: 'พว. สายชล จิตรเจริญ',
      deptHeadPosition: 'หัวหน้าหอผู้ป่วยอายุรกรรม',
      deptHeadDate: '12/04/2567',
      projectOwnerNamePage2: 'พว. ณัฐกานต์ วงศ์สุวรรณ',
      projectOwnerDatePage2: '12/07/2567',
      approverName: 'พว. ดารานี พรหมมินทร์',
